...
const effectiveVersion = versionName || baseVersion;
...
if (pkg.version !== effectiveVersion) {
  throw new Error(`package.json version ${pkg.version} is not synchronized with manifest version ${effectiveVersion}`);
}
...
console.log(`Validation passed for ${effectiveVersion}`);
