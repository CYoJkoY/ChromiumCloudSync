...
const entries = [
  'manifest.json','background.js','legacy-crypto.js','sync-core.js','i18n.js','theme.js','runtime.js','update.js','extension-storage.js','extension-storage-watch.js','popup-i18n.js','ui-overrides.css',
